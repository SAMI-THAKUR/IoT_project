...
def count_students_status(date):
    ...
    student_rfid_tags = [student["rfid"] for student in db["data"].find()]
...
total_students = db.data.count_documents({})
...
if attendance_data:
    ...
    for entry in attendance_data:
        ...
        st.write(f'<div style="font-size: 18px; font-family: monospace; color: #16FF00; background-color: #31363F; padding-left: 5px; padding-right: 5px; display: inline-block;">Id: {tag}</div>', unsafe_allow_html=True)
        st.divider()
